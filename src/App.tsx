...
function App() {
  ...
  const [isBudgetConfirmModalOpen, setIsBudgetConfirmModalOpen] =
    React.useState(false);
  const [isRequirementModalOpen, setIsRequirementModalOpen] =
    React.useState(false);
        ...
        <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-900 mb-3 leading-tight">
              Panipat Uptown Property
            </h1>
            <p className="text-base text-gray-700 mb-2 leading-relaxed">
              Unable to find what you are exactly looking for
            </p>
            <p className="text-sm text-gray-600 leading-relaxed">
              Please choose from the options below to help us assist you better
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            >
              ...
              <p className="text-gray-600 text-xs leading-relaxed">
                Looking for homes, apartments, or plots
              </p>
            </a>
            ...
            >
              ...
              <p className="text-gray-600 text-xs leading-relaxed">
                Shops, offices, or business spaces
              </p>
            </a>
  ...
  const handleContactUs = () => {
    ...
    window.open(
      `https://wa.me/919518091945?text=Hi, I'm interested in this property: ${propertyDetail}`,
      "_blank"
    );
  };
      ...
      <main className="max-w-4xl mx-auto px-2 sm:px-6 lg:px-8 py-4">
        ...
        <div className="mt-5 bg-gradient-to-r from-green-500 to-emerald-600 rounded-xl shadow-md p-4 text-white">
          <div className="text-center">
            ...
            <p className="text-green-100 mb-4 text-xs sm:text-sm">
              Join our WhatsApp channel to get instant notifications about new
              properties, price updates, and exclusive deals in Panipat.
            </p>
            <a
              href="https://www.whatsapp.com/channel/0029Va8pBW66rsQldWJXg61d"
              target="_blank"
              rel="noopener noreferrer"
          ...
          <div className="space-y-4">
            <div className="border-b border-gray-100 pb-4">
              ...
              <p className="text-gray-700 text-sm leading-relaxed">
                We understand your exact requirements and budget, then guide you
                with the best property options in Panipat. From consultation to
                site visits and closing the deal, we make the process simple,
            ...
            <div className="border-b border-gray-100 pb-4">
              <h4 className="text-sm font-semibold text-gray-800 mb-2">
                Q2. What areas do you specialize in?
              </h4>
              <p className="text-gray-700 text-sm leading-relaxed">
                We deal in Huda Sectors, HRERA-approved projects, and almost all
                areas across Panipat.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700 text-sm leading-relaxed">
                We are a team of experienced real estate consultants in Panipat.
                With years of local expertise and strong market knowledge, we
                help buyers and investors find the right property with trust and
                confidence.
              </p>
            </div>
          </div>
        ...
        <div className="mt-5 bg-white rounded-xl shadow-md p-4">
          ...
          <div className="flex justify-center space-x-4">
            <a
              href="https://www.instagram.com/panipat_properties_uptown/"
            ...
            <a
              href="https://www.facebook.com/panipatpropertyuptown/"
            ...
            <a
              href="https://www.youtube.com/@UptownProperties"
